Object.assign(pc, function () {
    ...
    Object.assign(GraphNode.prototype, {
         ...
         * @description Executes a provided function once on the graph node and all of its descendants for the nodes.
         * @param {Function} callback Function to execute on the graph node and for each descendant node.
         * @param {Object} [thisArg] Value to use as this when executing callback fucntion.
         * @example
